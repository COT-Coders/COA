    ...
    <body >
        <section class="section">
            <div class="container-fluid" style="background-color: white; margin-top: 50">
                ...
                <div class="row" style ="margin-left:10; margin-right:10">
                    ...
                    <div class="col-sm-4 col-md-6">
                        ...
                        <div class="row" >
                            ...
                            <img src="<?php echo base_url();?>assets/img/university.jpg" style="width: 100%">

                            <p class="text-justify" style="margin-top: 10"> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
        ...
        <section>
            <div class="container-fluid" style="background-color: #e2e2e4;">
                ...
                <div class="row" style ="margin-left:10; margin-right:10;">
                    ...
                    <div class="col-sm-4 col-md-3"> </div>
                        <div class="col-sm-4 col-md-6">
                            ...
                            <div class="row">
                                <div class="card-transparent col-sm-6 col-md-6 rounded" style="margin-top: 20px;">
                                  <!--<h3 class="text-center" style="margin-top: 20">
                                        Our Mission                
                                  </h3>-->
                                  <img class="card-img-top" src="<?php echo base_url();?>assets/img/mission.jpg" alt="Card image" style="height: 250px">
                                  <div class="card-body">
                                ...
                                <div class="card-transparent col-sm-6 col-md-6 rounded" style="margin-top: 20px;" >
                                  ...
                                  <img class="card-img-top" src="<?php echo base_url();?>assets/img/vision.jpg" alt="Card image" style="height: 250px">
                        ...
                        <div class="col-sm-4 col-md-6">
                            ...
                            <div class="row">
                                <div class="card-transparent col-sm-6 col-md-6 rounded" style="margin-top: 20px;">
                                  ...
                                  <img class="card-img-top" src="<?php echo base_url();?>assets/img/faculty.jpg" alt="Card image" style="height: 250px">
                                  <div class="card-body">
                                ...
                                <div class="card-transparent col-sm-6 col-md-6 rounded" style="margin-top: 20px;" >
                                  ...
                                  <img class="card-img-top" src="<?php echo base_url();?>assets/img/academic_r1.jpeg" alt="Card image" style="height: 250px">
                        ...
                        <div class="col-sm-4 col-md-6">
                            ...
                            <div class="row">
                                <div class="card-transparent col-sm-6 col-md-6 rounded" style="margin-top: 20px;">
                                  ...
                                  <img class="card-img-top" src="<?php echo base_url();?>assets/img/resercs_sample.jpg" alt="Card image" style="height: 250px">
                                  <div class="card-body">
                                    <h3  style="margin-top: 20">
                                        Research               
                                    </h3>
                                ...
                                <div class="card-transparent col-sm-6 col-md-6 rounded" style="margin-top: 20px;" >
                                  ...
                                  <img class="card-img-top" src="<?php echo base_url();?>assets/img/students.jpg" alt="Card image" style="height: 250px">
