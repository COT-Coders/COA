					...
					<ul class="nav navbar-nav navbar-right" style="font-weight:bolder;">
						<?php
							if($this->session->userdata('logged_in')) {
								echo "<li><a href=".site_url()."/logout"."><span class='glyphicon glyphicon-user' aria-hidden='true'></span>"." Logout"."</a></li>";
							}
							else {
								echo "<li><a href=".site_url()."/login"."><span class='glyphicon glyphicon-user' aria-hidden='true'></span>"." Login"."</a></li>";
							}
						?>
						<li><a href="<?php echo site_url(); ?>/signup">SignUp</a></li>
...
>>>>>>> 70c54f0a6bf5e6c4238c9e07420a41a815f6a224
